...
[![hexlet-check](https://github.com/aigul-b/middle-python-project-428/actions/workflows/hexlet-check.yml/badge.svg)](https://github.com/aigul-b/middle-python-project-428/actions)
...
```bash
git clone https://github.com/aigul-b/middle-python-project-428.git
